...
function _empty() {}function _awaitIgnored(value, direct) {
  ...
  render: function render() {
    ...
    }), _vm._v(" "), !!this.$scopedSlots['misc-item-below'] ? _c('li', { on: { "mouseenter": function mouseenter($event) {
          _vm.hovered = true;
        } } }, [_vm._t("misc-item-below", null, { "suggestions": _vm.suggestions, "query": _vm.text })], 2) : _vm._e()], 2) : _vm._e()])], 1);
  },
  staticRenderFns: [],
